/**
 * @Classname NextNodeInBinaryTreeLcof
 * @Created by zgw
 ...
 */
public class NextNodeInBinaryTreeLcof {
    ...
    public static Node<Integer> getNext(Node<Integer> node) {
        ...
        // 直到找到一个是它 父节点的左子节点 的节点。如果这样的节点存在，那么这个节点的父节点就是我们要找的下一个节点。
        // 直到找到它的父节点f，f是其父节点的左子节点，f的父节点就是要找的节点
        while (parent != null) {
